...
const Footer = () => {
  ...
  return (
    <>
      {/* CTA Section */}
      <section id="footer" className="py-20 bg-[#002366] text-white mt-20">
      ...
      <footer className="bg-[#002366] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span className="opacity-80">Room 117-118, Hoveniersstraat 30, Box 27, 2018 Antwerp, Belgium</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center text-sm opacity-60">
            <p>&copy; 2024 Kalp Diamonds BV. All rights reserved. | Certified by GIA | IGI | HRD</p>
          </div>
        </div>
      </footer>
    </>
